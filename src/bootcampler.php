...
<head>
    ...
    <title>Bootcamp Yönetimi - Bootcamp</title>
...
<body>
    ...
    <main class="container">
        ...
        <div style="margin-bottom: 2.5rem;">
            ...
            <p style="color: var(--text-secondary);">Yeni eğitim programları tanımlayın, sorumlu eğitmenler atayın ve öğrencilerin kayıt süreçlerini yönetin.:DEĞİŞİKLİK YAPILDI</p>
        </div>
